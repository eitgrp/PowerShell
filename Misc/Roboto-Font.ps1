...
# Instead of spending ages working out how to get the COM property to work, I've used a script I found online: https://www.alkanesolutions.co.uk/2021/12/06/installing-fonts-with-powershell/    #
##################################################################################################################################################################################################
...
function Install-Font {  
    ...
    $fontDirectory = "$Env:temp\Roboto"
    #Loop through fonts in the same directory as the script and install/uninstall them
    foreach ($FontItem in (Get-ChildItem -Path $fontDirectory | 
